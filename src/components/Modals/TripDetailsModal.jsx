...
const TripDetailsModal = ({ setTripDetailsModalActive, tripId }) => {
    ...
    return (
        <>
            ...
            <button className="update-trip-details-btn">Update Trip Details</button>
            <button className="delete-trip-details-btn" data-id={tripId} onClick={handleDelete}>Delete Trip</button>
            <button className="close-trip-details-btn" onClick={()=> setTripDetailsModalActive(false)}>Close Trip Details</button>
